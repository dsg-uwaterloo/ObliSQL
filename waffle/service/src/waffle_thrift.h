...
typedef struct _waffle_thrift_init_db_args__isset {
  _waffle_thrift_init_db_args__isset() : keys(false), values(false) {}
  bool keys :1;
  bool values :1;
} _waffle_thrift_init_db_args__isset;

class waffle_thrift_init_db_args {
 public:

  waffle_thrift_init_db_args(const waffle_thrift_init_db_args&);
  waffle_thrift_init_db_args& operator=(const waffle_thrift_init_db_args&);
  waffle_thrift_init_db_args() noexcept {
  }

  virtual ~waffle_thrift_init_db_args() noexcept;
  std::vector<std::string>  keys;
  std::vector<std::string>  values;

  _waffle_thrift_init_db_args__isset __isset;

  void __set_keys(const std::vector<std::string> & val);

  void __set_values(const std::vector<std::string> & val);

  bool operator == (const waffle_thrift_init_db_args & rhs) const
  {
    if (!(keys == rhs.keys))
      return false;
    if (!(values == rhs.values))
  ...
  bool operator < (const waffle_thrift_init_db_args & ) const;
...
class waffle_thrift_init_db_pargs {
 public:


  virtual ~waffle_thrift_init_db_pargs() noexcept;
  const std::vector<std::string> * keys;
  const std::vector<std::string> * values;
...
class waffle_thrift_init_db_result {
 public:

  waffle_thrift_init_db_result(const waffle_thrift_init_db_result&) noexcept;
  waffle_thrift_init_db_result& operator=(const waffle_thrift_init_db_result&) noexcept;
  waffle_thrift_init_db_result() noexcept {
  }

  virtual ~waffle_thrift_init_db_result() noexcept;

  bool operator == (const waffle_thrift_init_db_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const waffle_thrift_init_db_result &rhs) const {
  ...
  bool operator < (const waffle_thrift_init_db_result & ) const;
...
class waffle_thrift_init_db_presult {
 public:


  virtual ~waffle_thrift_init_db_presult() noexcept;
