...
sequence_id::~sequence_id() noexcept {
}
...
sequence_id::sequence_id(const sequence_id& other0) noexcept {
  client_id = other0.client_id;
  client_seq_no = other0.client_seq_no;
  server_seq_no = other0.server_seq_no;
}
sequence_id& sequence_id::operator=(const sequence_id& other1) noexcept {
