	...
	testCases := []Query{
		{
			...
			requestQuery: &resolver.ParsedQuery{
				...
				SearchVal:  []string{getRandomValue(0, 99999)},
		...
		},
		{
			...
			requestQuery: &resolver.ParsedQuery{
				...
				SearchVal:  []string{getRandomValue(0, 161630), getRandomValue(0, 49999)},
		...
		// 		SearchVal:     []string{getRandomValue(0, 49999), getRandomValue(0, 49999)},
		// 		SearchType:    []string{"point", "point"},
		...
		// 			start, end := getRandomRange(0, 99999, getRandomNumber(5))
		...
		// 		SearchVal:   []string{getRandomValue(0, 49999), getRandomValue(0, 56249)},
		// 		SearchType:  []string{"point"},
