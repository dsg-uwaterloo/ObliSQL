...
func main() {
	...
	bHostPtr := flag.String("bh", "localhost", "Address of Batcher")
	bPortPtr := flag.String("bp", "9500", "Port of Batcher")
	...
	resolverService := resolver.NewResolver(ctx, *bHostPtr, *bPortPtr, traceLoc, metaDataLoc, joinMapLoc, tracer)
