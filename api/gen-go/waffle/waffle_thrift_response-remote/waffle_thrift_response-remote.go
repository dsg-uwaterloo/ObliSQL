...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void async_response(sequence_id seq_id, i32 op_code,  result)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := waffle.NewWaffleThriftResponseClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "async_response":
    ...
    value0 := argvalue0
    tmp1, err171 := (strconv.Atoi(flag.Arg(2)))
    if err171 != nil {
      Usage()
      return
    }
    ...
    err177 := containerStruct2.ReadField3(context.Background(), jsProt176)
    if err177 != nil {
      Usage()
      return
    }
    argvalue2 := containerStruct2.Result_
    value2 := argvalue2
    fmt.Print(client.AsyncResponse(context.Background(), value0, value1, value2))
    fmt.Print("\n")
    break
  case "":
    Usage()
