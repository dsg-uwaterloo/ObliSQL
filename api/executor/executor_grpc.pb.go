...
func (c *executorClient) InitDb(ctx context.Context, in *RequestBatch, opts ...grpc.CallOption) (*wrapperspb.BoolValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedExecutorServer) InitDb(context.Context, *RequestBatch) (*wrapperspb.BoolValue, error) {
