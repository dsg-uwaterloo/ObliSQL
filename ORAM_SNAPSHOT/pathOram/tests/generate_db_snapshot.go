...
func main() {
	...
	fileLoc := "/home/haseeb/Desktop/MakeSnapshot/ObliSQL/ORAM_KARIM/serverInput_1.txt"
	fmt.Println("Generating for: ", fileLoc)
	var requests []request.Request
	file, err := os.Open(fileLoc) // TODO: define tracefile path here
	if err != nil {
